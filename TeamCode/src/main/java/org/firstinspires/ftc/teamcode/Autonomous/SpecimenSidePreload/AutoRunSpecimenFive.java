...
public class AutoRunSpecimenFive implements Runnable {
    ...
    private static double firstSampleExtend = 0.47;
    private static double secondSampleExtend = 0.57;
    private static double thirdSampleExtend = 0.58;
    private static double thirdSampleExtendFar = 0.58;
    private static double firstSpecimenExtend = 0.29;
    private static double secondSpecimenExtend = 0.55;
    private static double deliverSampleExtend = 0.4;
    ...
    public AutoRunSpecimenFive(SampleMecanumDrive Drive){
        drive = Drive;
    }
...
//        drive.followTrajectorySequenceAsync(SpecimenSidePreloadTrajectories.distanceFromChamber());
        ...
        ActionDelayer.time(1300, this :: extendFirstSample);
        ActionDelayer.time(1700, this :: CollectFirstSample);
    }
    ...
    private void DeliverSample(AutoState finishState){
        ...
        ActionDelayer.time(600, Intake :: spitoutGround);
        ...
        if (finishState == AutoState.DELIVERED_THIRD){
            ActionDelayer.time(450, this :: extendThirdSampleFar);
            ActionDelayer.time(800, () -> extendFirstSpecimen());
        }
    }
    ...
    private void goToFirstSpecimen(){
        ...
        ActionDelayer.time(500, this :: TransferAndScoreFirstSpecimen);
    }
    ...
    private void TransferAndScoreFirstSpecimen(){
        ...
        ActionDelayer.time(1350, () -> drive.followTrajectorySequenceAsync(SpecimenSidePreloadTrajectories.scoreFirstSpecimen()));
        ActionDelayer.time(2150, ActionManager :: releaseSample);
        ActionDelayer.time(2150, () -> progress = AutoState.SCORED_FIRST);
    }
    ...
    private void goToSecondSpecimen(){
        ...
        ActionDelayer.time(700, Intake :: collect);
        ActionDelayer.time(700, this :: extendSecondSpecimen);
        ActionDelayer.time(1200, () -> drive.followTrajectorySequenceAsync(SpecimenSidePreloadTrajectories.collectSecondSpecimen()));
        ActionDelayer.time(1500, this :: TransferAndScoreSecondSpecimen);
    }
    ...
    private void goToThirdSpecimen(){
        ...
        ActionDelayer.time(1500, this :: TransferAndScoreThirdSpecimen);
    }
    ...
    private void goToFourthSpecimen(){
        ...
        ActionDelayer.time(1500, this :: TransferAndScoreFourthSpecimen);
    }
...
//        ActionDelayer.time(1100, () -> drive.followTrajectorySequenceAsync(SpecimenSidePreloadTrajectories.goToPark2()));
    ...
    private void extendFirstSample(){FrontSlides.extendPercentage(firstSampleExtend, 0.25);}
