...
@Autonomous(name = "BasketSixBlue", group = "blue", preselectTeleOp = "MainTeleOp")
public class BasketSixBlue extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        Initializations.initAuto(hardwareMap, telemetry, ColorSensor.AllianceColors.BLUE);
        AutoRunBasketSix autoCase = new AutoRunBasketSix(Hardware.drive);
        autoCase.init();
