...
import org.firstinspires.ftc.teamcode.Autonomous.BasketSidePreload.AutoRunBasketFive;
import org.firstinspires.ftc.teamcode.Autonomous.BasketSidePreload.AutoRunBasketFour;
import org.firstinspires.ftc.teamcode.Autonomous.BasketSidePreload.AutoRunBasketSix;
...
@Autonomous(name = "BasketFiveBlue", group = "blue", preselectTeleOp = "MainTeleOp")
public class BasketFiveBlue extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        Initializations.initAuto(hardwareMap, telemetry, ColorSensor.AllianceColors.BLUE);
        AutoRunBasketFive autoCase = new AutoRunBasketFive(Hardware.drive);
        autoCase.init();
