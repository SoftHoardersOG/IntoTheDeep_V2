...
@Autonomous(name = "BasketSideSpecimenPreload")
public class BasketSpecimenPreload extends LinearOpMode {
    @Override
...
//            }
        ...
        if(!isStopRequested()){
            AutoRunBasketSidePreload autoCase = new AutoRunBasketSidePreload(drive);
            autoCase.run();
